            ...
            <div className="text-2xl flex items-center justify-center">
              ...
              <div className="m-2 gap-3">
                <div className="flex justify-center items-center flex-col">
                  <img src="src/assets/solo-leveling.webp" className="rounded sm:h-75 h-[50%] object-cover" />
                  <p className="text-center sm:w-[450px]">Solo Leveling | ARISE OVERDRIVEANNONCE<br/> POUR LES GAMEURS...<br/>
                  Prochainement Solo Leveling fera son appartion comme jeux vidéo uniquement sur steam dans un premier temps. 
                  Un jeu d'action-rpg, faites évoluer votre perso du rang E.</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center sm:flex-row flex-col m-2 gap-3">
                <div className="flex flex-row p-2 m-2">
                  <p className="w-50 flex justify-center">FIGURINE POP, DU GROUPE BTS,<br/>Jimin.<br/>
                    Sortie en Août 2025, à partir de 14€99.
                  </p>
                  <img src="src/assets/pop-bts.webp" className="sm:w-auto w-30 sm:h-40 h-50 object-cover" />
                </div>

                <div className="flex flex-row justify-center p-2 m-2">
                  <img src="src/assets/jutjuso-keisein.webp" className="h-[0.5%] sm:h-40 w-30 object-cover" />
